...
SECRET_KEY = "django-insecure-g4%@qwi3l+c#tafjs*qo+&uev8=#(0sz@snw7desddd7z^&!tn"
...
INSTALLED_APPS = [
    ...
    "orders",    # Register the orders app
]

MIDDLEWARE = [
    'django.middleware.security.SecurityMiddleware',  # Handles security features
    'django.contrib.sessions.middleware.SessionMiddleware',  # Manages sessions
    'django.middleware.common.CommonMiddleware',  # Common operations like URL redirects
    ...
    'django.contrib.messages.middleware.MessageMiddleware',  # Manages error/warning messages
